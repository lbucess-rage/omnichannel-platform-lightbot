                      ...
                      >
                        <div class="mr-2 self-center">
                          <div class="w-8 h-8 relative float-left">
                            <img
                              src="https://static.intercomassets.com/avatars/6481560/square_128/shwe-1682487791.png"
                              alt="Shwe avatar"
                              class="absolute rounded-full border-2 border-custom-white bg-custom-black text-white text-center text-base w-5 h-5 leading-5 top--1 left-6 z-2 transition-custom duration-250 ease"
                            />
                            <img
                          ...
                          <div class="flex flex-col cursor-pointer">
                            <div class="overflow-hidden overflow-ellipsis whitespace-nowrap text-sm font-normal">
                              <span class="text-black">
                                Ready to up-level your teams productivity with
                                AI? ✨
                              </span>
                            </div>
